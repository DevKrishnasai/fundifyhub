...
import { WORKFLOW_EVENTS, REQUEST_STATUS_PHASE } from '../workflow/constants';
...
// import { REQUEST_STAGE } from '../workflow/stage-constants'; // dynamic import in func
...
export function canViewRequestDetail(
  ...
  const { REQUEST_STAGE } = require('../workflow/enums');
...
export function getPhaseNumber(status: REQUEST_STATUS): number {
