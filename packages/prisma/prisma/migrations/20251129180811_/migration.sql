...
CREATE TABLE "requests" (
    ...
    "adminProcessingFee" DOUBLE PRECISION,
    ...
    "adminRequestedInfo" TEXT,
    "bankAccountNumber" TEXT,
    "bankIfscCode" TEXT,
    "bankAccountName" TEXT,
    "upiId" TEXT,
    "bankDetailsSubmittedAt" TIMESTAMP(3),
    "assignedAgentId" TEXT,
    "inspectionScheduledAt" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "payment_orders_loanId_idx" ON "payment_orders"("loanId");

-- CreateIndex
CREATE INDEX "payment_orders_requestId_idx" ON "payment_orders"("requestId");

-- CreateIndex
CREATE INDEX "payment_orders_emiScheduleId_idx" ON "payment_orders"("emiScheduleId");

-- CreateIndex
CREATE INDEX "payment_orders_customerId_idx" ON "payment_orders"("customerId");
...
-- AddForeignKey
ALTER TABLE "payment_orders" ADD CONSTRAINT "payment_orders_loanId_fkey" FOREIGN KEY ("loanId") REFERENCES "loans"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payment_orders" ADD CONSTRAINT "payment_orders_requestId_fkey" FOREIGN KEY ("requestId") REFERENCES "requests"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payment_orders" ADD CONSTRAINT "payment_orders_emiScheduleId_fkey" FOREIGN KEY ("emiScheduleId") REFERENCES "emi_schedules"("id") ON DELETE CASCADE ON UPDATE CASCADE;
