...
import serviceRoutes from './admin-service.routes';
import agentsRoutes from './admin-agents.routes';
import analyticsRoutes from './admin-analytics.routes';
import auditLogsRoutes from './admin-audit-logs.routes';
import {
  getActiveLoansController,
  getPendingRequestsController
} from '../controllers/admin.controller';
import { getRequestsController } from '../controllers/admin.controller';
